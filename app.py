...
def extract_skills(resume_text):
    ...
    data = pd.read_csv(r"C:/Users/DELL/Project/Project 2 Resumes/skills.csv") # reading the csv file
...
import pickle as pk
# Loading the model
model = joblib.load('C:/Users/DELL/Project/Project 2 Resumes/modelDT.joblib')

Vectorizer = pk.load(open(r'C:/Users/DELL/Project/Project 2 Resumes/vector.pkl', 'rb'))
